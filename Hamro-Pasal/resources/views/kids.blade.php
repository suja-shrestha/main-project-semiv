{{-- FILE: resources/views/kids.blade.php --}}
...
{{-- =================================================================== --}}
{{--     THIS <STYLE> BLOCK IS THE CRUCIAL PART THAT WAS MISSING       --}}
{{-- =================================================================== --}}
<style>
    ...
    <section class="filtered-products-section">
        @if($products->isEmpty())
            <div style="text-align: center; padding: 4rem 1rem;">
                <h3>No products found for Kids.</h3>
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-rating">
                                <div class="stars">@for ($i = 1; $i <= 5; $i++)<i class="{{ $i <= ($product->rating ?? 0) ? 'fas' : 'far' }} fa-star"></i>@endfor</div>
                            </div>
