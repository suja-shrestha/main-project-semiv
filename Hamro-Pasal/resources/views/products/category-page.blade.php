{{-- FILE: resources/views/products/category-page.blade.php --}}

@php use Illuminate\Support\Str; @endphp

{{-- =================================================================== --}}
{{--     THIS IS THE MOST IMPORTANT LINE. IT INCLUDES YOUR NAVBAR.       --}}
{{-- =================================================================== --}}
@extends('layouts.app')


{{-- This tells Laravel where to inject this page's content into the layout --}}
@section('content')

{{-- These styles ensure this page looks identical to your Men/Women/Kids pages --}}
<style>
